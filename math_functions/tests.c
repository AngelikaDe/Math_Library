...
START_TEST(s21_pow_test_2) {
  ...
  ck_assert_ldouble_infinite(s21_pow(s21_INFINITY, 2));
...
int main(void) {
  ...
  tcase_add_test(tc, s21_sin_2_test);
  tcase_add_test(tc, s21_cos_test);
  tcase_add_test(tc, s21_cos_2_test);
